...
const STORES = [
  { id: 'canadacomputers.com', label: 'Canada Computers' },
  { id: 'bestbuy.ca', label: 'Best Buy' },
  { id: 'staples.ca', label: 'Staples' },
  { id: 'walmart.ca', label: 'Walmart' },
  { id: 'memoryexpress.com', label: 'Memory Express' },
  { id: 'thesource.ca', label: 'The Source' },
  { id: 'costco.ca', label: 'Costco' }
];
